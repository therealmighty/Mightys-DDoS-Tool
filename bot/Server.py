...
class Server(Colours):
	...
	def print_logo(self):
		...
		if platform.system() == "Windows":
			try:
				ctypes.windll.kernel32.SetConsoleTitleW("DoS Tool by Mighty")
			except Exception:
				pass
		else:
			print("\033]0;DoS Tool by Mighty\007", end="")

		# Print ASCII art logo
		text = pyfiglet.figlet_format("DoS Tool by Mighty")
